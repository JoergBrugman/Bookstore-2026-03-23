namespace GetUseAcademy.Bookstore.Saasification.Wizard;

using System.Environment.Configuration;
using System.Media;
using Microsoft.Foundation.Company;

codeunit 50105 "BSB Company Info. Wizard Meth"
{
    ...
    var
        ...
        WizardTitleTxt: label 'Company Information Setup', Comment = 'de-DE=Firmendaten';
        WizardDescTxt: label 'Provide the Name and E-Mail of your Company.', Comment = 'de-DE=Unternehmensname und E-Mailadresse einrichten.';
    begin
    ...
    var
        SetupAlreadyDoneQst: Label 'This setup is already done. Do you want to open the setup page instead?', Comment = 'de-DE=Die Einrichtung ist bereits abgeschlossen. Möchten Sie stattdessen die Einrichtungsseite öffen?';
    begin
